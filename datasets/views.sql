...
WITH rule_results (
    ...
    SELECT
        'failed_payment_without_order',
        'Failed payments should reference an existing order',
        'CRITICAL',
        0::BIGINT,
        (
            SELECT COUNT(*)
    ...
    SELECT
        'pending_payment_without_order',
        'Pending payments should reference an existing order',
        'CRITICAL',
        0::BIGINT,
        (
            SELECT COUNT(*)
