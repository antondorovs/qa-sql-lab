...
paid or shipped orders, successful, refunded, and failed payments stay tied to
existing order records, new or cancelled orders do not appear with successful
