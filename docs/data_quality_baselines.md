...
Coverage rules flag active users that still have no order history and
countries with non-deleted users but no order coverage. They also summarize
countries where active-user primary address coverage is incomplete.
